                    ...
                    {!! Form::open(['route' => 'search_courses', 'method' => 'GET']) !!}
                        <div class="row">
                            <div class="col-md-5">
                                ...
                                {{ Form::date('date_s', $request->date_s, ['class' => 'form-control border border-success', 'id' => 'date_s', 'required']) }}
                            </div>
                            <div class="col-md-5">
                                {{ Form::label('date_f', 'Fecha Final') }}
                                {{ Form::date('date_f', $request->date_f, ['class' => 'form-control border border-success', 'id' => 'date_f', 'required']) }}
                            </div>
                            <div class="col-md-2">
